...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '🌑🥷🏿cShBot;0113;0;https://i.ibb.co/sqL5mDs/IMG20230902143052.jpg;https://chat.whatsapp.com/BQjl1mjYHrNEKcYfUjAeZk',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "cShBot",
    BOT_NAME: process.env.BOT_NAME || 'cShBot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? '🌑🥷🏿;cShBot;https://i.ibb.co/sqL5mDs/IMG20230902143052.jpg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "27633389272",
